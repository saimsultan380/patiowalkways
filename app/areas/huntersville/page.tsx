...
import { huntersvillePage as page } from "@/data/huntersville-page";
...
export default function HuntersvilleAreaPage() {
  return (
    <main className="min-h-screen">
      ...
      <ServicePageHero
        ...
        imageAlt="Landscaping and hardscaping services in Huntersville, NC"
      ...
      <ServiceSplitSection
        ...
        imageAlt="Outdoor services for Huntersville properties"
      />
      <AreaServicesGrid
        id={page.services.id}
      ...
      <ServiceSplitSection
        ...
        imageAlt="Connected outdoor improvements in Huntersville"
        reverse
      />
      <HowItWorks
        label="HOW WE WORK"
      ...
      />
      <OtherAreas currentSlug="huntersville" />
      <FAQ
        items={page.faqs}
        title={
          <>
            Huntersville outdoor project{" "}
      ...
      <CTASection
        ...
        title={
          <>
            ...
            <span className="text-stone">Huntersville Outdoor Space?</span>
          </>
        }
