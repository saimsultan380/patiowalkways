...
import { monroePage as page } from "@/data/monroe-page";
...
export default function MonroeAreaPage() {
  return (
    <main className="min-h-screen">
      ...
      <ServicePageHero
        ...
        imageAlt="Landscaping and hardscaping services in Monroe, NC"
      ...
      <ServiceSplitSection
        ...
        imageAlt="Outdoor services for Monroe properties"
      />
      <AreaServicesGrid
        id={page.services.id}
      ...
      <ServiceSplitSection
        ...
        imageAlt="Connected outdoor improvements in Monroe"
        reverse
      />
      <HowItWorks
        label="HOW WE WORK"
      ...
      <ServiceSplitSection
        ...
        imageAlt="Commercial outdoor improvements in Monroe, NC"
      />
      <ServiceContentBlock
        id={page.whyUs.id}
      ...
      />
      <OtherAreas currentSlug="monroe" />
      <FAQ
        items={page.faqs}
        title={
          <>
            Monroe outdoor project{" "}
      ...
      <CTASection
        ...
        title={
          <>
            ...
            <span className="text-stone">Monroe Outdoor Space?</span>
          </>
        }
