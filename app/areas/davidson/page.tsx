...
import { davidsonPage as page } from "@/data/areas";
...
export default function DavidsonAreaPage() {
  return (
    <main className="min-h-screen">
      ...
      <ServicePageHero
        ...
        imageAlt="Landscaping and hardscaping services in Davidson, NC"
      ...
      <ServiceSplitSection
        ...
        imageAlt="Outdoor services for Davidson properties"
      />
      <AreaServicesGrid
        id={page.services.id}
      ...
      <ServiceSplitSection
        ...
        imageAlt="Connected outdoor improvements in Davidson"
        reverse
      />
      <HowItWorks
        label="HOW WE WORK"
      ...
      />
      <OtherAreas currentSlug="davidson" />
      <FAQ
        items={page.faqs}
        title={
          <>
            Davidson outdoor project{" "}
      ...
      <CTASection
        ...
        title={
          <>
            ...
            <span className="text-stone">Davidson Outdoor Space?</span>
          </>
        }
