            ...
            <div className="flex flex-col">
              {areas.map((area, index) => (
                <motion.div
                  ...
                  className="group py-6 border-b border-white/15 last:border-0 flex items-center justify-between cursor-default"
                >
                  <h3 className="text-3xl md:text-5xl lg:text-6xl font-playfair transition-colors duration-300 group-hover:text-stone">
                    {area}
                  </h3>
                  <span className="text-stone opacity-0 group-hover:opacity-100 transition-opacity duration-300 text-xl">
                    →
                  </span>
                </motion.div>
              ))}
